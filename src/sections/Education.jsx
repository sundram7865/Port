      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="glass p-8 rounded-3xl border border-primary/20 relative group overflow-hidden">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2 glass p-6 rounded-2xl border-dashed border-primary/40 flex items-center justify-between bg-primary/5">
