      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            <div
              key={idx}
              className="group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1 border border-white/5 hover:border-primary/20 transition-all duration-500"
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video">
                ...
                bg-gradient-to-t from-background via-background/20
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {project.tags.map((tag, tagIdx) => (
                    <span
                      key={tagIdx}
                      className="px-3 py-1 rounded-full bg-primary/5 text-[10px] font-medium border border-primary/10 text-primary transition-all duration-300"
                    >
                      {tag}
                    </span>
                  ))}
