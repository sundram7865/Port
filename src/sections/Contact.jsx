          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                I'm currently open to new opportunities and exciting projects in AI development and Backend Engineering. 
                Whether you need an SDE for your team or a full-stack consultant, let's talk!
              </p>
            </div>
          </div>
        </div>
